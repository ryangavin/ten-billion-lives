...
| ------------------------- | ----------: | ---------: |
| Cold city entry           | 2,988.37 ms | ≤ 3,500 ms |
| Zoom p95                  | 1,892.51 ms | ≤ 2,500 ms |
| Visible-coordinate pick   | 1,312.98 ms | ≤ 2,500 ms |
| Initialize observer B     | 2,769.93 ms | ≤ 3,500 ms |
| Worst retained frame      |     0.81 ms | ≤ 16.67 ms |
