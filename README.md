...
This repository will contain a browser-based, server-synchronized interactive observatory for a fictional Earth-like planet. The authoritative simulation operates on conserved population, place, and mobility fields. Web clients procedurally manifest stable local people from that shared state.
...
- Shared semantic events across observers.
